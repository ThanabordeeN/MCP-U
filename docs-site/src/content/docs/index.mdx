...
hero:
  ...
  actions:
    - text: Quick Start
      link: /mcpu/guides/getting-started/
      icon: right-arrow
      variant: primary
    - text: GitHub
      link: https://github.com/ThanabordeeN/mcpu
      icon: external
      variant: minimal
---
...
| `i2c_scan` | Scan I2C bus *(requires `begin_i2c()`)* |
| `i2c_write_reg` | Write byte to I2C register |
| `i2c_read_reg` | Read N bytes from I2C register |
